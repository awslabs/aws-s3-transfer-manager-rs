...
mod reporting {
    ...
    use super::super::admission::ReservationQueueDiagnosticSample;
    use super::super::arena::ArenaDiagnosticSnapshot;
    use super::super::maintenance::MaintenanceDiagnosticSnapshot;
    use super::super::metrics::MemoryMetrics;
    use super::super::PoolInner;

    /// Periodic reporting state owned exclusively by the maintenance worker.
    pub(in crate::runtime::buffer_pool) struct PeriodicDiagnosticReporter {
        interval: Duration,
    ...
    impl PeriodicDiagnosticReporter {
        ...
        pub(in crate::runtime::buffer_pool) fn new(
            pool: &PoolInner,
            interval: Duration,
        ) -> Option<Self> {
        ...
        pub(in crate::runtime::buffer_pool) fn next_snapshot(&self) -> Instant {
            self.next_snapshot
        }

        /// Emits one current-state sample and advances the delta baseline.
        pub(in crate::runtime::buffer_pool) fn emit(&mut self, pool: &PoolInner) {
        ...
        pub(in crate::runtime::buffer_pool) fn schedule_next(
            &mut self,
    ...
    mod tests {
        ...
        use super::super::super::test_util::{
            poll_reserve, test_pool, test_pool_with_scan_and_diagnostics,
        };
        use super::*;
        ...
        fn reporter_arms_one_complete_interval_from_its_baseline() {
            ...
            let reporter = PeriodicDiagnosticReporter::new(&pool.inner, interval)
...
#[cfg(not(all(test, s3_tm_loom)))]
pub(super) use reporting::PeriodicDiagnosticReporter;
